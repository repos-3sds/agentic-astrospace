...
function reportBlocks(input: AskReportInput): ReportBlock[] {
  ...
  if (!reading) return [
    ...
    { kind: 'subtitle', text: 'Your way of life guide' },
    { kind: 'rule' },
    { kind: 'heading', text: 'Prepared For' },
    { kind: 'body', text: clean(input.profileName) || 'Selected profile' },
    { kind: 'source', text: `Generated by Siddha · ${generated}` },
...
function canvasPages(input: AskReportInput): HTMLCanvasElement[] {
  ...
  pages.forEach((page, index) => {
    ...
    ctx.textAlign = 'left';
    ctx.fillText('SIDDHA · PERSONAL VEDIC GUIDANCE', margin, height - 48);
    ctx.textAlign = 'right';
