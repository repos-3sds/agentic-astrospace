...
| Codex | Mobile screen build backlog — per-mode Ask Answer templates first, then offline/stale/partial-calculation states, then the rest of the ❌ list in `mobile_screen_build_plan.md`. Not yet started | — | Proposed, awaiting claim | `ui/src/app/features/mobile/**` | 2026-08-09 |
