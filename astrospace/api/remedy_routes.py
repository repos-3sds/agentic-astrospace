...
``is_convention_dependent`` and a ``tradition_source``, and every affliction
carries "This is a flag, not a verdict." Those fields are the product's
safety contract (design_principles.md §4 and §6), so they are passed through
verbatim rather than summarised into a score.
"""
